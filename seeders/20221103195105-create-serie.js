    ...
    await queryInterface.bulkInsert('series', [
      {
        ...
        synopsis: "Based on the book 'Fire and Blood' by George R.R. Martin. The series focuses on the Targaryen house, three hundred years before the events seen in 'Game of Thrones'.",
        punctuation: "4",
        nextsevendays: "true",
        theater: "false",
        cine: "false",
        ...
        synopsis: "Meredith Grey's life is not easy. Try to take control of your life, even if your job is one of those that make your life impossible. Meredith is a first-year intern surgeon at Grace Hospital.",
        punctuation: "3",
        nextsevendays: "false",
        theater: "true",
        cine: "true",
        ...
        synopsis: "American animated comedy created by Matt Groening for the Fox company. The series is a satirical parody of the style of the American middle class embodied by a family with the same name...",
        punctuation: "5",
        nextsevendays: "false",
        theater: "false",
        cine: "true",
        ...
        synopsis: "After a particle accelerator causes a freak storm, police science investigator Barry Allen is struck by lightning and falls into a coma. Months later he wakes up with the power to move at super speed",
        punctuation: "1",
        nextsevendays: "false",
        theater: "false",
        cine: "true",
        ...
        synopsis: "A young autistic surgeon who suffers from the syndrome of the wise man begins to work in a prestigious hospital. There he will have to overcome the skepticism with which his colleagues receive him.",
        punctuation: "4",
        nextsevendays: "true",
        theater: "false",
        cine: "false",
        ...
        synopsis: "After a vintage Chucky doll turns up at a suburban yard sale, an American city is thrown into chaos, after a series of horrific crimes begin to expose the city's hypocrisies and secrets.",
        punctuation: "2",
        nextsevendays: "false",
        theater: "true",
        cine: "true",
        ...
        synopsis: "After turning 50, Walter White, a high school chemistry teacher, learns that he has incurable lung cancer. The brutal news prompts him to make a drastic change in his life: he decides, with the help of a former student, to manufacture amphetamines and put them on sale",
        punctuation: "5",
        nextsevendays: "false",
        theater: "false",
        cine: "true",
        ...
        synopsis: "The series follows Daniel Harrelson, a S.W.A.T. Torn between allegiance to the streets and duty to his fellow officers, he is assigned by aggressive and confident 10-David SWAT Team Leader Jeff Mumford to lead a highly trained police unit tasked with stop crimes in Los Angeles.",
        punctuation: "2",
        nextsevendays: "false",
        theater: "false",
        cine: "true",
